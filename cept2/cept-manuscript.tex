...
%
Actually, in 80s, Roos {\it et al.} developed a primitive version of CASPT2 which involves only the external IC configurations\cite{ROOS1982197} and, as summarized in Ref.~\onlinecite{doi:10.1002/qua.23052}, reported that the semi-internal subspaces in FOIS can have large impact on the dynamic correlation energy.
%
...
%
To overcome this issue, we introduce PNO expansion in the external subspace in a similar vein to Ref. ~\onlinecite{:/content/aip/journal/jcp/145/12/10.1063/1.4963019}.
%
...
%
%%The explicit formuals for the orthonormalized amplitudes are given in Appendix I.
...
%
This behavior of CASPT2 model is actually in contrast to previous studies such as Ref. ~\onlinecite{doi:10.1063/1.4900878} where the 2${}^1\text{A}_\text{g}^{-}$ state becomes lower in the energy for C$_{8}$H${}_{10}$ with cc-pVDZ basis set.
%
...
{
  \begin{figure}[H]
    \scalebox{1.0}{\includegraphics{Fig-Polyene-v2.pdf}}
