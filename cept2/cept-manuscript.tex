...
%
%However, 
Alternatively to the generalized Fock operator for CASPT2 and to Dyall's Hamiltonian for NEVPT2, use of Fink's zeroth-order Hamiltonian\cite{FINK2006461,FINK200939} has been attracting much interest, leading to the so-called Retaining-degree-of-Excitation Perturbation Theory (REPT).
%
...
%
Even though the standard variant MR-CEPA/0 lacks exact size-consistency, the MR-CEPA/0 and other variants of linearlized IC-MRCC can often reproduce the shape of potential energy curves to an accurate degree in comparison with a more complete version of IC-MRCC theory.\cite{AK74,AK77}
%
